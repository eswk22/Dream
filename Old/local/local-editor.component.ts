...
@Component({
	selector: 'local-editor',
	templateUrl: './local-editor.component.html',
	encapsulation: ViewEncapsulation.None,
	styles: [require('./local-editor.component.css')],
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: forwardRef(() => LocalEditorComponent),
			multi: true
		},
		ActionTaskService
	],
...
export class LocalEditorComponent implements OnInit, AfterViewInit {
