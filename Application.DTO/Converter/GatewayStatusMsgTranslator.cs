...
{
    public class GatewayStatusMsgTranslator : EntityMapperTranslator<GatewaySnapshot, GatewayStatusMessage>
    {
        public override GatewayStatusMessage BusinessToService(IEntityTranslatorService service, GatewaySnapshot value)
        {
		...
		public override GatewaySnapshot ServiceToBusiness(IEntityTranslatorService service, GatewayStatusMessage value)
        {
            GatewaySnapshot gatewayDTO = null;
            if (value != null)
            {
                gatewayDTO = new GatewaySnapshot();
