...
{
    public class GatewayTranslator : EntityMapperTranslator<GatewayDTO, GatewaySnapshot>
    {
        public override GatewaySnapshot BusinessToService(IEntityTranslatorService service, GatewayDTO value)
        {
		...
		public override GatewayDTO ServiceToBusiness(IEntityTranslatorService service, GatewaySnapshot value)
        {
