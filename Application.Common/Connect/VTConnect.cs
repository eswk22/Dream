...
namespace ExecutionEngine.Common.Connect
{
    ...
    using SessionVt = com.jagacy.SessionVt;
    ...
    public class VTConnect : SessionVt, SessionObjectInterface
    {
        public VTConnect(string sessionName, string host, int port) : base(sessionName, host, port)
        {   /*  26 */
            open();
        }
        public VTConnect(string sessionName, string host, int port, string terminalType) : base(sessionName, host, port, terminalType)
        {   /*  33 */
            open();
        }
        public VTConnect(string sessionName, string host, int port, string terminalType, string sslKeyFile, string sslKeyPassword) : base(sessionName, host, port, terminalType)
        {   /*  40 */
            open(sslKeyFile, sslKeyPassword);
        }
